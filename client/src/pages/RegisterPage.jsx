          ...
          <div className="auth-card-dark">
            ...
            <div className="info-note-dark">
              ...
              <p className="info-text-dark">
                <strong>Note:</strong> Using a company email (non-Gmail) will automatically sign you up as an <strong>Employer</strong>. Gmail accounts will sign up as <strong>Job Seeker</strong>.
              </p>
            </div>
